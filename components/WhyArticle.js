    ...
    <div className="">
      ...
      <div className="flex flex-col p-4 rounded-lg shadow-lg md:p-8 sm:flex-row bg-stone-100">
        <div>
          <section className="mb-8 section-indicator">
            ...
            <article className="p-6 bg-white border border-gray-300 rounded-lg shadow-sm">
              <p className="leading-relaxed text-gray-700">
                ...
                <span className="highlight">25만 배의</span>
                성능 향상을 이뤘다. 성능의 발전에 따라 지원하는 기능을 추가하며
                국민 편의성도 향상시켰다. 1호기는 객관적 기상예보 체계
                구축했으며, 2005년 도입된 2호기는 스마트폰과 네비게이션 출시에
                맞춰 5km 범위의 초단기 수치예보모델을 적용한 동네예보를
                추가했다. 이를 통해 지역별 날씨 예보지원이 시작됐다.
                <span className="highlight">
                  동네예보 도입 초기 6시간마다 이뤄지던 일기예보 갱신 시간도
                  3시간, 1시간으로 점차 단축됐다.
                </span>
                3호기는 전지구모델 해상도를 기존 55Km에서 25Km로 줄이며 수치
            ...
            <p className="mt-4 leading-relaxed text-gray-700">
              ...
              있고,{" "}
              <span className="highlight">
                4호기에 비해 92배나 빨라졌어요. 하지만 아직도 날씨 적중률은
                50%를 넘지못해요. 왜 그럴까요?
              </span>
            </p>
          </section>
          ...
          <section className="mb-8 section-indicator">
            ...
            <div className="p-6 mt-4">
              <p className="mb-4 leading-relaxed text-gray-700">
                ...
                부는지 등 챙겨야 할 게 정말 많다고 봐야 하고요 여기에
                <span className="highlight">
                  태양열과 지면 에너지, 지역적 특성(도시인지 산골인지), 지형
                  고도까지 시시각각 반영해야 한다고 해요.
                </span>
              </p>
              ...
              <p className="mt-4 mb-4 leading-relaxed text-gray-700">
                ...
                게다가 측정하는 장소도 하나의 변수가 되는데요.{" "}
                <span className="highlight">
                  실제로 우리 동네 날씨를 보더라도 우리 집이 아니라
                  &lsquo;관측소가 설치된 곳&rsquo;
                </span>
                이다 보니 실제 우리 집 앞 날씨와는 조금 다를 수도 있다는
                설명입니다.
              </p>
            </div>
          ...
          <article className="p-6 mb-8 bg-white border border-gray-300 rounded-lg shadow-sm">
            <p className="leading-relaxed text-gray-700">
              기상청에 따르면 날씨 예보의 단계별 역할 비중이
              <span className="highlight">
                슈퍼컴퓨터의 예보 40%, 관측 자료 32%, 마지막 예보관의 판단이 28%
                정도 차지한다고 합니다.
              </span>{" "}
          ...
          <p className="mt-4 mb-4 leading-relaxed text-gray-700">
            ...
            판에{" "}
            <span className="highlight">
              한국의 예보관들은 12시간 반복 교대근무와 잦은 순환보직 시스템 탓에
              전문성을 갖추기가 어려운 상황이라고 이야기 합니다.
            </span>
          </p>
