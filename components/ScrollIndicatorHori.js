...
const ScrollIndicatorHori = () => {
  ...
  return (
    <div className="relative inset-x-0 top-0 items-center justify-center hidden my-auto transition duration-500 transform shadow-xl left-2 h-80 xl:left-4 bg-stone-200 rounded-xl opacity-80 hover:opacity-100 xl:flex">
      <div className="flex flex-col items-center justify-center w-12 h-64 gap-4 lg:left-4">
...
export default ScrollIndicatorHori;
