          ...
          <section className="mb-8 section-indicator">
            ...
            <article className="p-6 mb-4 bg-white border border-gray-300 rounded-lg shadow-sm">
              <p className="leading-relaxed text-gray-700">
                ...
                제기했습니다. 강수 예보를 평가하는 잣대로 '정확도'를 쓰는 것은
                적절하지 않다는 겁니다. 같은 강수 상황을 반영했더라도, 기상청이
                발표해온 예보 '정확도'와 감사원이 제시한 예보 '적중률'은 계산
                방식에 차이가 있습니다. 강수 예보에 대한 경우의 수는
                4가지입니다.
              </p>
            </article>
            ...
            <article className="p-6 mt-4 mb-8 bg-white border border-gray-300 rounded-lg shadow-sm">
              <p className="leading-relaxed text-gray-700 b-12">
                ...
                심지어 "기상청이 비가 온다는 예보를 1년간 전혀 하지 않아도 강수
                예보 정확도는 89.5%에 달한다"고 꼬집었습니다. 비와 관련 없는
                맑은 날은 빼고, 실제로 비가 내렸거나 비를 예보한 날만 따져
                계산해야 한다고 지적했습니다. 실제로 미국·영국 등의 선진국에서도
                적중률을 강수 예보 기준으로 삼고 있습니다.
              </p>
