...
export default function Home() {
  ...
  return (
    <>
      ...
      <DidItRain className="flex flex-col items-center w-11/12 gap-4 p-5 justify-evenly rounded-xl lg:flex-row md:flex-col md:justify-evenly lg:justify-evenly bg-slate-200 mb-11" />
